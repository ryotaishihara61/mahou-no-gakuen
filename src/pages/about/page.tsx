  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-purple-50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <img 
                src="https://static.readdy.ai/image/eaa52119033ac8864aa00eb190fc57f3/e4d3c6fb5f9533011cb1efe274b8323c.png" 
                alt="合同会社 魔法の学園 ロゴ" 
            ...
            <nav className="hidden md:flex space-x-6">
              <Link to="/" className="text-gray-600 hover:text-pink-500 transition-colors cursor-pointer text-sm">ホーム</Link>
              <Link to="/about" className="text-pink-500 font-medium cursor-pointer text-sm">会社概要</Link>
              <a href="#" className="text-gray-600 hover:text-pink-500 transition-colors cursor-pointer text-sm">お問い合わせ</a>
            </nav>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        ...
        <section className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-lg p-8 border border-pink-100">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-3">新たな活動</h2>
            <div className="w-16 h-1 bg-gradient-to-r from-pink-400 to-purple-400 mx-auto rounded-full"></div>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-white/80 backdrop-blur-sm py-8 border-t border-pink-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center space-x-6 text-xs">
              <Link to="/" className="text-gray-500 hover:text-pink-500 transition-colors cursor-pointer">ホーム</Link>
              <Link to="/about" className="text-gray-500 hover:text-pink-500 transition-colors cursor-pointer">会社概要</Link>
              <a href="#" className="text-gray-500 hover:text-pink-500 transition-colors cursor-pointer">お問い合わせ</a>
              <a href="https://readdy.ai/?origin=logo" className="text-gray-500 hover:text-pink-500 transition-colors cursor-pointer">Website Builder</a>
            </div>
